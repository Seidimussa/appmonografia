document.addEventListener('DOMContentLoaded', () => {
        ...
        sections: [
            {
                ...
                lessons: [
                    { id: 1, title: 'Descobrindo HTML e tags', type: 'learn', url: 'licoes/licao-01.html', locked: false, completed: false },
                    { id: 2, title: 'Estruturação de texto com tags', type: 'learn', url: 'licoes/licao-02.html', locked: true, completed: false },
                    { id: 3, title: 'Botões de construção', type: 'learn', url: 'licoes/licao-03.html', locked: true, completed: false },
                    { id: 4, title: 'Noções básicas de HTML 1', type: 'practice', url: 'licoes/licao-04.html', locked: true, completed: false },
                    { id: 5, title: 'Criando links', type: 'learn', url: 'licoes/licao-05.html', locked: true, completed: false },
                    { id: 6, title: 'Adicionando Imagens', type: 'learn', url: 'licoes/licao-06.html', locked: true, completed: false },
                    { id: 7, title: 'Noções básicas de HTML 2', type: 'practice', url: 'licoes/licao-07.html', locked: true, completed: false },
                ]
            },
            {
                id: 2, title: 'HTML Intermediário', description: 'Vincule vários arquivos HTML para criar um site', locked: true,
                lessons: [
                    { id: 8, title: 'Coletando Informações', type: 'learn', url: 'licoes/licao-08.html', locked: true, completed: false },
                    { id: 9, title: 'Agrupando Elementos', type: 'learn', url: 'licoes/licao-09.html', locked: true, completed: false },
                    { id: 10, title: 'Listas de construção', type: 'learn', url: 'licoes/licao-10.html', locked: true, completed: false },
                    { id: 11, title: 'Vinculando páginas da web', type: 'learn', url: 'licoes/licao-11.html', locked: true, completed: false },
                    { id: 12, title: 'HTML Intermediário', type: 'practice', url: 'licoes/licao-12.html', locked: true, completed: false },
                ]
            },
            { id: 3, title: 'HTML Semântico', description: 'Use elementos semânticos', locked: true, lessons: [ { id: 13, title: 'Alternativas semânticas', type: 'learn', url: 'licoes/licao-13.html', locked: true, completed: false }, ] },
            { id: 4, title: 'Acessibilidade', description: 'Crie páginas acessíveis', locked: true, lessons: [ { id: 17, title: 'Noções básicas de acessibilidade HTML', type: 'learn', url: 'licoes/licao-17.html', locked: true, completed: false }, ] },
            { id: 5, title: 'Formulários HTML', description: 'Reúna dados do usuário', locked: true, lessons: [ { id: 20, title: 'Criando Formulários', type: 'learn', url: 'licoes/licao-20.html', locked: true, completed: false }, { id: 23, title: 'Certificado de Conclusão', type: 'certificate', url: '#', locked: true, completed: false } ] },
        ]
    };
    ...
    const resetProgress = () => { if (confirm('Tem certeza?')) { localStorage.removeItem('courseProgress'); courseData = JSON.parse(JSON.stringify(initialCourseData)); renderApp(); } };
    const changeSection = (sectionId) => { const section = courseData.sections.find(s => s.id === sectionId); if (section && !section.locked) { courseData.currentSectionId = sectionId; renderApp(); if (window.innerWidth < 1024) sidebar.classList.remove('visible'); } };
